  ...
  return (
    <div className="min-h-screen bg-white px-4 py-10">
      <div className="mx-auto max-w-xl rounded-3xl border border-zinc-200 bg-zinc-50 p-6">
        ...
        <h1 className="mt-2 text-3xl font-black text-zinc-900">Game Setup</h1>
        <p className="mt-3 text-zinc-600">Prototype page for room name, mode, filters, and continue flow.</p>
