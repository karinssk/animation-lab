            ...
            <div className="hv2-shell">
              ...
              <header className="space-y-3">
                <div className="flex items-center justify-between">
                  <Link href="/preferences-setup" className="hv2-pressable flex items-center gap-2 rounded-2xl border border-zinc-200 bg-zinc-50 px-3 py-2">
                    <Image src="/toast-logo.png" alt="Profile" width={34} height={34} className="rounded-lg border border-zinc-200" />
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.14em] text-zinc-500">Profile</p>
                      <p className="text-base leading-4 font-bold text-zinc-900">Preferences</p>
                    </div>
                  </Link>
                  <span className="hv2-live-badge rounded-full bg-orange-100 px-3 py-1 text-xs font-bold text-orange-700">
                    Live
                  </span>
                </div>
