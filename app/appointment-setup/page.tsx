  ...
  return (
    <div className="min-h-screen bg-white px-4 py-10">
      <div className="mx-auto max-w-xl rounded-3xl border border-zinc-200 bg-zinc-50 p-6">
        ...
        <h1 className="mt-2 text-3xl font-black text-zinc-900">Appointment Setup</h1>
        <p className="mt-3 text-zinc-600">Prototype page for group date range selection.</p>
        <div className="mt-6 flex gap-2">
          <Link href="/home-screen-v2" className="rounded-xl bg-zinc-900 px-4 py-2 text-sm font-semibold text-white">
            Back to Home Screen
          </Link>
